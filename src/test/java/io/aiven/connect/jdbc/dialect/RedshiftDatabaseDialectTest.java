...
public class RedshiftDatabaseDialectTest extends BaseDialectTest<RedshiftDatabaseDialect> {
                ...
                new TableDefinition(
                        ...
                        List.of(
                                ...
                                createColumnDefinition(
                                        columnUuid,
                                        Types.OTHER,
                                        RedshiftDatabaseDialect.UUID_TYPE_NAME, UUID.class),
                                createColumnDefinition(
                                        columnJson,
                                        Types.OTHER,
                                        RedshiftDatabaseDialect.JSON_TYPE_NAME, String.class),
                                createColumnDefinition(
                                        columnJsonb,
                                        Types.OTHER,
                                        RedshiftDatabaseDialect.JSONB_TYPE_NAME, String.class)
                        )
                );
    }
    ...
    public void shouldCreateConverterForJdbcTypes() {
        assertColumnConverter(
                Types.OTHER,
                RedshiftDatabaseDialect.JSON_TYPE_NAME,
                Schema.STRING_SCHEMA,
                String.class
        );
        assertColumnConverter(
                Types.OTHER,
                RedshiftDatabaseDialect.JSONB_TYPE_NAME,
                Schema.STRING_SCHEMA,
                String.class
        );
    }
    ...
    public void shouldCreateConverterForUuidType() {
        assertColumnConverter(
                Types.OTHER,
                RedshiftDatabaseDialect.UUID_TYPE_NAME,
                Schema.STRING_SCHEMA,
                UUID.class
        );
    }
    ...
    public void shouldSanitizeUrlWithoutCredentialsInProperties() {
        assertSanitizedUrl(
                "jdbc:Redshift://localhost/test?user=fred&ssl=true",
                "jdbc:Redshift://localhost/test?user=fred&ssl=true"
        );
    }
    ...
    public void shouldSanitizeUrlWithCredentialsInUrlProperties() {
        assertSanitizedUrl(
                "jdbc:Redshift://localhost/test?user=fred&password=secret&ssl=true",
                "jdbc:Redshift://localhost/test?user=fred&password=****&ssl=true"
        );
    }
