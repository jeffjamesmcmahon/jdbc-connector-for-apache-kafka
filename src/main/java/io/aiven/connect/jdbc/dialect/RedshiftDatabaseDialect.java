...
public class RedshiftDatabaseDialect extends GenericDatabaseDialect {
    ...
    public List<String> buildAlterTable(
        ...
        for (SinkRecordField field: fields) {
            ...
            builder.append(" ADD");
            ArrayList<SinkRecordField> ar = new ArrayList<>();
            ar.add(field);
            writeColumnsSpec(builder, ar);
    ...
    // Note - Redshift does not support Upsert - so we won't override and let the base class
    // throw the NotImpl exception.
//    @Override
